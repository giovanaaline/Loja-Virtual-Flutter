              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text('R\$ ${cartProduct.productData.price.toStringAsFixed(2)}',
                      style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16.0, color: primaryColor)),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    children: <Widget>[
                      IconButton(
                        icon: Icon(Icons.remove, color: cartProduct.quantity > 1 ? primaryColor : Colors.grey[500]),
                        onPressed: cartProduct.quantity > 1 ?() {
                          CartModel.of(context).dec_inc_Product(cartProduct, -1);
                        } : null,
                      ),
