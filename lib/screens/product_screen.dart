      ...
      body: ListView(
        children: <Widget>[
          ...
          child: Carousel(
            ...
            autoplay: false, //vai mudando as imagens automaticamente
          ...
          Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text("R\$ ${product.price.toStringAsFixed(2)}", style: TextStyle(fontSize: 22.0, fontWeight: FontWeight.bold,
                color: primaryColor)),
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                          decoration: BoxDecoration(
                              ...
                              border: Border.all(color: s == size ? primaryColor : Colors.grey)
                          ),
                        width: 50.0,
